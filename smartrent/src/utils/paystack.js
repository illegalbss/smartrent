...
// `subaccount` routes the payment straight to the landlord's own Paystack
// subaccount (0% platform cut — see server/src/controllers/payoutController.js).
// `plan` opts the tenant into recurring billing matching their room's rent frequency.
export async function payWithPaystack({ publicKey, email, amount, reference, channels, subaccount, plan, onSuccess, onClose }) {
